...
function renderDetailsTab() {
    ...
    return `
        ...
        <!-- Story Endings -->
        <div class="storymode-form-section" style="margin-top: 20px; border-top: 1px solid var(--SmartThemeBorderColor); padding-top: 20px;">
            <details>
...
export async function addCoverToGallery(blueprint, imageUrl, prompt, metadata = {}) {
    ...
    console.log('[BlueprintEditor] Added cover to gallery:', coverEntry.id);
