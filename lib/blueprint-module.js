...
export const PHASE_CONFIG = {
    ...
    4: {
        name: 'Resolutions',
        progress: 100,
        description: 'Crafting endings & cover...',
...
export function validateBlueprint(blueprint) {
    ...
    if (!Array.isArray(blueprint.scene_plan) || blueprint.scene_plan.length === 0) {
        ...
        blueprint.scene_plan.forEach((scene, index) => {
            ...
            // Validate beats array (REQUIRED now)
...
BEAT COMPLETION: Output @@BEAT:N@@ when you've addressed a beat's content in your response.
...
Example: If the current beat is "First Steps Inside" (establishment), mark it complete once you've described the characters entering and the atmosphere:

  The tatami mats creaked softly as they stepped inside, the scent of incense and aged wood settling around them like a gentle embrace.

  @@BEAT:1@@

  Julie paused at the threshold, her eyes adjusting to the dim interior...

SCENE TRANSITION: End your response with @@NEXT_SCENE@@ on its own line when:
