...
import { calculateTotalRounds } from './module.js';
...
export class CharacterMerger {
    ...
    async showConflictDialog(detection) {
        ...
        try {
            ...
            const message = `${conflicts.length} character(s) in this blueprint differ from your existing characters.\n\n` +
            ...
            const confirmed = await callGenericPopup(
                ...
                POPUP_TYPE.CONFIRM,
                '',
                { okButton: 'Keep My Versions', cancelButton: 'Use Blueprint Versions' }
            );
...
export class BlueprintMerger {
    ...
    async syncSettings(blueprint) {
        const settings = {
            ...
            arcLength: calculateTotalRounds(blueprint),
            syncResult: null,
        };
