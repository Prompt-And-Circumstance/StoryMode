...
export async function generateBlueprint(request, storyTypes, authorStyles, options = {}) {
    const { phased = false, startPhase, partialBlueprint, phaseOverrides = {} } = options;
...
export default {
    ...
    setStoryTypes,
    setAuthorStyles,
    // getStoryTypeById - internal use only, not exported
    // getAuthorStyleById - internal use only, not exported
    MODULE_NAME,
    METAPHOR_LEVELS,
    LENGTH_PRESETS,
    PHASE_CONFIG,
