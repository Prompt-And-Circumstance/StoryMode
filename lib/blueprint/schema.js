 ...
 * 
 * Refer: https://github.com/Prompt-And-Circumstance/scenario-card-spec-v1/
 *
...
export const BLUEPRINT_FIELDS = {
                ...
                items: {
                    ...
                    nested: {
                        ...
                        comment: {
                            ...
                            required: false,
                            max: 500,
                            description: 'Entry name/label'
                        },
                        content: {
                            type: 'string',
                            required: true,
                            max: 10000,
                            description: 'Entry lore content'
                        },
                        constant: {
                            type: 'boolean',
                            required: false,
                            description: 'Always include in generation'
                        },
                        order: {
                            type: 'number',
                            required: false,
                        ...
                        extensions: {
                            ...
                            nested: {
                                source_world: {
                                    type: 'string',
                                    required: false,
                                    description: 'Original lorebook name'
                                },
                                selected_for_generation: {
                                    type: 'boolean',
                                    required: false,
                                    description: 'User selected during wizard'
                                },
                                generation_timestamp: {
                                    type: 'string',
                                    required: false,
                                    description: 'ISO timestamp of selection'
                                }
                            },
            ...
            metadata: {
                ...
                nested: {
                    source_worlds: {
                        ...
                        required: false,
                        items: { type: 'string' },
                        description: 'Original lorebook names (if merged)'
                    },
                    selected_at_generation: {
                        type: 'boolean',
                        required: false,
                        description: 'User selected entries during generation'
                    },
                    generation_timestamp: {
                        type: 'string',
                        required: false,
                        description: 'ISO timestamp when entries were selected'
                    }
                },
                description: 'Lorebook metadata'
            }
        },
        description: 'Optional embedded lorebook for self-contained blueprints'
    },
    ...
    linked_lorebooks: {
        ...
        required: false,
        items: { type: 'string' },
        description: 'Names of ST lorebooks to reference (not embedded)'
    }
};
