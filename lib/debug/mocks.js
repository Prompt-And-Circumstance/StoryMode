...
// Side-effect import: loads handler-audit.js which registers window.StoryModeDebug.auditHandlers
...
/**
 * Generate Phase 3b mock: full detail for a batch of scenes
 * @param {number} batchIndex - Which batch (0-based)
