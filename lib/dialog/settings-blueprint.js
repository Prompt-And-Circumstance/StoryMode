...
export function setupBlueprintEvents(content, context) {
    ...
    setupBlueprintManagementHandlers(content, { updateStatusDisplay, refreshBlueprintPreview });
...
function setupBlueprintManagementHandlers(content, callbacks) {
    const { updateStatusDisplay, refreshBlueprintPreview } = callbacks;
    bindExportButton(content);
    bindEditButton(content, updateStatusDisplay, refreshBlueprintPreview);
    bindClearButton(content, updateStatusDisplay);
}
...
function bindClearButton(content, updateStatusDisplay) {
