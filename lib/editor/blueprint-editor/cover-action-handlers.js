...
export async function handleClearCover(e) {
    ...
    if (gallery.length === 0) {
        getCurrentBlueprint().metadata.coverGalleryIndex = null;
        getCurrentBlueprint().metadata.coverImageUrl = null;
        getCurrentBlueprint().coverImageUrl = null;
 ...
 */
export function handleRegeneratePrompt(e) {
    e.preventDefault();
