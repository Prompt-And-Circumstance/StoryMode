    ...
    return `
        ...
        <div class="storymode-scenes-list">
            ${scenes.map((scene, index) => `
                <div class="storymode-scene-card" data-scene-index="${index}">
                    <div class="storymode-scene-drag-handle" draggable="true" data-scene-index="${index}" title="Drag to reorder">
                        <i class="fa-solid fa-grip-vertical"></i>
                    </div>
                    <div class="storymode-scene-content">
