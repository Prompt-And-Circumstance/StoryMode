...
export function storeSceneImage(blueprintId, sceneIndex, imageData) {
    ...
    saveStorage();
    console.log(`[Scene Image Storage] Stored image for blueprint ${blueprintId}, scene ${sceneIndex}`);
    return true;
}
...
export function deleteSceneImage(blueprintId, sceneIndex) {
    ...
    saveStorage();
    console.log(`[Scene Image Storage] Deleted image for blueprint ${blueprintId}, scene ${sceneIndex}`);
    return true;
}
...
export function deleteBlueprintImages(blueprintId) {
    ...
    saveStorage();
    console.log(`[Scene Image Storage] Deleted ${count} images for blueprint ${blueprintId}`);
    return count;
}
...
export function clearAllImages() {
    ...
    console.log(`[Scene Image Storage] Cleared ${count} images across ${blueprintIds.length} blueprints`);
    return count;
}
...
function removeOldestImagesAcrossBlueprints(storage, count) {
    ...
    console.log(`[Scene Image Storage] Removed ${count} oldest images to enforce storage limits`);
}
