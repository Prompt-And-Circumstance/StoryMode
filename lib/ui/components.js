...
<div class="inline-drawer" id="blueprint_prompt_drawer">
    <div class="inline-drawer-toggle inline-drawer-header">
        <h4 class="storymode-section-title" style="margin: 0;">
            <i class="fa-solid fa-code"></i> Advanced Options
        </h4>
        <div class="inline-drawer-icon fa-solid interactable down fa-circle-chevron-down" tabindex="0" role="button"></div>
    </div>
    <div class="inline-drawer-content" style="display: none;">
...
<!-- Action Buttons -->
        <div class="storymode-generate-actions" style="margin-top: 24px; display: flex; flex-direction: column; align-items: center; gap: 12px;">
            <button id="blueprint_generate_btn" class="menu_button storymode-btn storymode-btn-primary" style="width: 300px; height: 60px; font-size: 1.1em;" title="Generate a story blueprint based on the settings above">
                <i class="fa-solid fa-wand-magic-sparkles"></i> Generate Blueprint
            </button>
            <button id="blueprint_cancel_generation_btn" class="menu_button storymode-btn storymode-btn-secondary" style="display: none; width: 300px; height: 60px; font-size: 1.1em;" title="Cancel the current blueprint generation">
