        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-bottom: 20px;">
            <div>
                ...
                <div class="storymode-form-group">
                    ...
                    <p class="storymode-form-hint" id="blueprint_custom_rounds_hint">Enter a custom number of scenes to override the selected length</p>
                </div>
            </div>
            <div>
                <div class="storymode-form-group">
...
export function renderBlueprintOverviewSubtab(blueprint, currentScene) {
    ...
    const authorStyleName = resolveAuthorStyleDisplayName(blueprint, authorStyles);
    ...
    return `
        ...
        <div class="storymode-blueprint-meta-row">
            ${renderInfoCards(blueprint, styleAnalysis, authorStyleName, { includeInlineAttr: true })}
        ...
        ${currentScene ? `
            <div class="storymode-card">
                ...
                ${renderCurrentSceneCard(currentScene, blueprint)}
            </div>
        ` : ''}
    `;
}
