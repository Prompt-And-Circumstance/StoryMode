...
export function renderBlueprintPreview(blueprintState) {
    ...
    const authorStyleMissing = authorStyleId && isStyleMissing('authorStyle', authorStyleId);

    // Check if embedded data is available for missing styles
    const hasEmbeddedStoryType = storyTypeMissing && blueprint.embeddedResources?.storyType;
    const hasEmbeddedAuthorStyle = authorStyleMissing && blueprint.embeddedResources?.authorStyle;
        ...
        <div class="inline-drawer-content" style="display: none;">
            ...
            <div class="storymode-blueprint-info-grid">
                <div class="storymode-info-card${storyTypeMissing ? ' storymode-missing-style' : ''}">
                    ...
                    ${storyTypeMissing ? `
                    <button class="menu_button storymode-add-style-btn" data-style-type="storyType" data-style-id="${escapeHtml(storyTypeId)}" data-style-name="${escapeHtml(blueprint.story_type_name || '')}" data-has-embedded="${hasEmbeddedStoryType ? 'true' : 'false'}" title="${hasEmbeddedStoryType ? 'Import this story type' : 'Create this story type manually'}">
