...
export function buildOverviewTabContent() {
    ...
    if (isScenario && blueprintState?.blueprint) {
        ...
        summaryItems.push({
            icon: 'layer-group',
            label: 'Phase',
            value: currentScene?.phase || phaseInfo.phase
        });
    } else {
        // Story Mode summary
            ...
            <div class="storymode-scenario-info-panel">
                ...
                <div class="storymode-scenario-info-body">
                    <p class="storymode-scenario-info-message">
                        Story type and pacing are managed by the active scenario.
                        To change these settings, edit the scenario or switch to Story Mode.
                    </p>
