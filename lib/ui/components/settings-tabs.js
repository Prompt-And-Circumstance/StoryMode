...
<div class="storymode-toggle">
<div class="storymode-toggle-info">
<span class="storymode-toggle-label">Generate Next Adventure Options</span>
<span class="storymode-toggle-description">Automatically generate 3 scenario options for continuing the story</span>
${createHelpIcon('When the story arc ends, generate themes and scenario options for the next adventure')}
</div>
<label class="storymode-switch">
...
<div class="storymode-form-group">
<label class="storymode-form-label">Next Adventure Profile ${createHelpIcon('Which API connection to use for generating next adventure scenario options')}</label>
