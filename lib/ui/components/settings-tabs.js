...
export function buildStoryArcSubtab() {
        ...
        <div class="storymode-section">
            ...
            <div class="storymode-mode-toggle">
                <button id="storymode-pacing-story"
                    ...
                    <i class="fa-solid fa-clock"></i> Story Mode
                </button>
                <button id="storymode-pacing-scenario"
                        class="storymode-mode-btn ${isScenario ? 'active' : ''}"
                        title="Blueprint-driven progression with beat/scene signals">
                    <i class="fa-solid fa-scroll"></i> Scenario Mode
                </button>
            </div>
            ${isScenario && blueprintState?.blueprint ? `
                <div class="storymode-mode-info">
                    <div class="storymode-mode-sublabel">Story features managed by active blueprint</div>
                    <div><strong>${escapeHtml(blueprintState.blueprint.title || blueprintState.blueprint.blueprint_title || 'Unknown')}</strong></div>
                    <div class="storymode-button-row" style="margin-top: 6px;">
                        <button id="view_blueprint_btn" class="menu_button storymode-btn-secondary">
                            <i class="fa-solid fa-eye"></i> View
                        </button>
                        <button id="stop_scenario_btn" class="menu_button storymode-btn-secondary">
                            <i class="fa-solid fa-right-from-bracket"></i> End Scenario
                        </button>
                    </div>
                </div>
            ` : isScenario ? `
                <div class="storymode-mode-info">
                    <i class="fa-solid fa-triangle-exclamation"></i> No blueprint loaded
                </div>
            ` : `
                <div class="storymode-mode-info">
                    Round-based progression with configurable features
                </div>
            `}
        </div>
    `;
    ...
    return pacingModeHtml + storyFeaturesHtml;
}
